<?php
$pageTitle = "Recipes | HyFun Foods - Delicious Potato Creations";
$additionalCss = "recipes.css";
$additionalJs = "recipes.js";
    ...
    <div class="container">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <p class="hero-subtitle">Transform ordinary meals into extraordinary experiences with our easy-to-make, incredibly tasty potato snack recipes. Perfect for every occasion!</p>
                ...
                <div class="search-container">
                    <div class="search-box">
                        ...
                        <input type="text" id="recipeSearch" placeholder="Search recipes by name, ingredient, or category...">
            ...
            <div class="hero-visual">
                ...
                <div class="floating-ingredients">
                    <div class="ingredient"><i class="fas fa-cheese"></i><span>Cheese</span></div>
                    <div class="ingredient"><i class="fas fa-pepper-hot"></i><span>Spices</span></div>
                    <div class="ingredient"><i class="fas fa-leaf"></i><span>Herbs</span></div>
                    <div class="ingredient"><i class="fas fa-bread-slice"></i><span>Bread</span></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="featured-slide active" data-id="1">
                <div class="slide-content">
                    ...
                    <div class="slide-info">
                        ...
                        <h3>Arabic Burger</h3>
                        <p class="recipe-desc">Crispy HyFun fries loaded with melted cheese, jalapeños, sour cream, and spring onions. Perfect game day snack!</p>
            ...
            <div class="featured-slide" data-id="2">
                <div class="slide-content">
                    ...
                    <div class="slide-info">
                        ...
                        <p class="recipe-desc">HyFun patty paired with fresh veggies and bold Texan spices in a soft burger bun. A fiery, flavor-packed delight!</p>
                        <div class="recipe-tags">
...
<section class="video-recipes section-bg" id="video-recipes">
    ...
    <div class="container">
        ...
        <div class="video-grid">
            ...
            <!-- Video 3: Three Cheese Messy Burger -->
            <div class="video-card">
                <div class="video-container">
                    <div class="video-thumbnail">
            ...
            <!-- Video 9: Cheesy Vegetable Quesadilla -->
            <div class="video-card">
                <div class="video-container">
                    <div class="video-thumbnail">
    ...
    <div class="container">
        <div class="share-content">
            ...
            <div class="share-options">
                <a href="#" class="share-option"><i class="fab fa-instagram"></i><h4>Instagram</h4><p>Tag @hyfunfoods</p></a>
                <a href="#" class="share-option"><i class="fab fa-facebook"></i><h4>Facebook</h4><p>Post in our community</p></a>
                <a href="#" class="share-option"><i class="fas fa-envelope"></i><h4>Email Us</h4><p>Send photos & feedback</p></a>
            </div>
            <div class="hashtag"><i class="fas fa-hashtag"></i><span>#HyFunRecipes #PotatoMagic #EasySnacking</span></div>
        </div>
    </div>
</section>
...
<div class="recipe-modal-overlay" id="recipeModal">
    <div class="recipe-modal">
        <button class="close-modal-btn" id="closeRecipeModal"><i class="fas fa-times"></i></button>
...
<div class="video-modal-overlay" id="videoModal">
    <div class="video-modal">
        <button class="close-video-btn" id="closeVideoModal"><i class="fas fa-times"></i></button>
